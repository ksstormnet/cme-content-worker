...
CREATE TABLE posts (
  ...
  title TEXT NOT NULL,
  content TEXT NOT NULL, -- JSON string with Elementor-like blocks
  excerpt TEXT,
...
-- Content blocks table for Elementor-style content structure
...
INSERT INTO settings (key, value, description) VALUES 
  ('blog_url_pattern', '/blog/', 'URL pattern for blog posts routing'),
  ('site_css_urls', '["https://cruisemadeeasy.com/wp-content/themes/theme/style.css"]', 'CSS URLs to monitor for changes'),
  ('css_sync_enabled', 'true', 'Enable automatic CSS change detection'),
