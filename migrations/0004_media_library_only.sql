-- Media Library Tables Only (Safe Migration)
...
CREATE TABLE IF NOT EXISTS media_files (
  ...
  caption TEXT,
  description TEXT,
  file_path TEXT NOT NULL, -- WordPress-style path: YYYY/MM/filename.ext
...
CREATE INDEX IF NOT EXISTS idx_media_files_featured ON media_files(is_featured);
...
-- Default media categories (INSERT OR IGNORE for safety)
INSERT OR IGNORE INTO media_categories (name, slug, description, sort_order, color) VALUES 
